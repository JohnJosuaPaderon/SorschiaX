...
namespace Sorschia.SystemCore.Processes
{
    ...
    {
        private readonly DeleteUserQuery _query;

        public DeleteUserModel Model { get; set; }

        public DeleteUser(IConnectionStringProvider connectionStringProvider, DeleteUserQuery query) : base(connectionStringProvider)
        {
            _query = query;
        }
