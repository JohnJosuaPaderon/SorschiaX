...
namespace Sorschia.SystemCore.Processes
{
    ...
    {
        private readonly GetPlatformQuery _query;

        public int Id { get; set; }

        public GetPlatform(IConnectionStringProvider connectionStringProvider, GetPlatformQuery query) : base(connectionStringProvider)
        {
            _query = query;
        }
