    ...
    public static class DbDataReaderExtensions
    {
        private static void Validate(DbDataReader reader, string fieldName)
        {
            ...
            if (reader.FieldCount <= 0)
                throw new SorschiaException("reader has no fields.");
        }
        ...
        private static T Get<T>(this DbDataReader instance, string fieldName, IFieldNameCache fieldNameCache, Convert<T> convert, T valueIfDefault = default)
        {
            if (fieldNameCache is null)
                throw new SorschiaException("fieldNameCache is null");
        ...
        public static DateTimeOffset GetDateTimeOffset(this DbDataReader instance, string fieldName, DateTimeOffset valueIfDefault = default) => instance.Get(fieldName, DbValueConverter.ToDateTimeOffset, valueIfDefault);

        public static DateTimeOffset GetDateTimeOffset(this DbDataReader instance, string fieldName, IFieldNameCache fieldNameCache, DateTimeOffset valueIfDefault = default) => instance.Get(fieldName, fieldNameCache, DbValueConverter.ToDateTimeOffset, valueIfDefault);
        ...
        public static DateTimeOffset? GetNullableDateTimeOffset(this DbDataReader instance, string fieldName, DateTimeOffset? valueIfDefault = default) => instance.Get(fieldName, DbValueConverter.ToNullableDateTimeOffset, valueIfDefault);

        public static DateTimeOffset? GetNullableDateTimeOffset(this DbDataReader instance, string fieldName, IFieldNameCache fieldNameCache, DateTimeOffset? valueIfDefault = default) => instance.Get(fieldName, fieldNameCache, DbValueConverter.ToNullableDateTimeOffset, valueIfDefault);
