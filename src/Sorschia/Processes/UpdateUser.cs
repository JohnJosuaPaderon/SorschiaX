...
{
    public class UpdateUser : IRequest<UpdateUser.Result>
    {
        ...
        public ICollection<long> DeletedUserApplicationIds { get; set; } = new List<long>();
        public ICollection<long> DeletedUserRoleIds { get; set; } = new List<long>();
        public ICollection<long> DeletedUserPermissionIds { get; set; } = new List<long>();
