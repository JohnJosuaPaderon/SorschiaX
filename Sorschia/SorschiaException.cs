...
namespace Sorschia
{
    ...
    {
        public SorschiaException(bool isMessageViewable = false)
        {
            IsMessageViewable = isMessageViewable;
        }

        public SorschiaException(string message, bool isMessageViewable = false) : base(message)
        {
            IsMessageViewable = isMessageViewable;
        }

        public SorschiaException(string message, Exception innerException, bool isMessageViewable = false) : base(message, innerException)
        {
            IsMessageViewable = isMessageViewable;
        }

        protected SorschiaException(SerializationInfo info, StreamingContext context, bool isMessageViewable = false) : base(info, context)
        {
            IsMessageViewable = isMessageViewable;
        }
